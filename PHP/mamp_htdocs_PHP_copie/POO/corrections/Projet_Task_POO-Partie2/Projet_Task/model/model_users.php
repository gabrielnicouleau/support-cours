...
class ModelUser{
    ...
    public function readUserByMail():array | string{
        try{
            ...
            $req = $this->getBdd()->prepare('SELECT id_user, name_user, firstname_user, email_user, mdp_user FROM users WHERE email_user = ? LIMIT 1');
    ...
    public function updateUser():string{
        try{
            //YD : requête préparée
            $req = $this->getBdd()->prepare('UPDATE users SET name_user = ?, firstname_user = ?, email_user = ?, mdp_user = ? WHERE id_user = ?');
